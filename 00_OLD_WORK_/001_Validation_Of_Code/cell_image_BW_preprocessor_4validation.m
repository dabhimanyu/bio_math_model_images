function [img , BW] = cell_image_BW_preprocessor_4validation(...
    img , adaptive_thresh_toggle , BW_sensitivity  , opening_radius ) % , closing_radius)
%
