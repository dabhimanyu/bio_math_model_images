...
artificial_Img_FilePath = ['/Users/abhimanyudubey/' ...
    ...
    '001_Real_Img_via_reg_max_/' ...
    '009_New_Images_FOR_PAPER_REVIEW_/' ...
    '003_Artificial_Images_For_Review_'] ; 

% % % 9069 Path 
% % % For "9069" Real Cell Images :

real_cell_img_filepath = [
    '/Users/abhimanyudubey/' ...
    'Pictures/BIO MATH MODEL/' ...
    '001_Real_Img_via_reg_max_/' ...
    '009_New_Images_FOR_PAPER_REVIEW_/' ...
...
real_cell_img_exp_dir = ['/Users/abhimanyudubey/' ...
    'Pictures/BIO MATH MODEL/' ...
    '001_Real_Img_via_reg_max_/' ...
    '009_New_Images_FOR_PAPER_REVIEW_/' ...
...
%         'MarkerSize', 20 , 'Color', 'r' , 'LineWidth', 2) ; 
%     hold off ; 
...
%     plot(CC.centroid(: , 1) , CC.centroid(: , 2) , '.' ,...
%         'MarkerSize', 12 , 'Color', 'r') ; hold off ; 
%     title(sprintf('Showing %i Detected Cells' ,...
%         CC.NumObjects) , 'FontSize',22) ; 
% % 
%     %
...
% % %%
% %     exportgraphics(fig , ...
% %         fullfile(real_cell_img_exp_dir , ['a_' , onlyFilenames{i}]) ,...
% %         'resolution' , 300 , 'ContentType' , 'image') ;
...
save(fullfile(real_cell_img_exp_dir , '002_Cells_Centroid_Data_for_9238_') , ...
